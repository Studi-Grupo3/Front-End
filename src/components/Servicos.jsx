  ...
  return (
    ...
    >
      <div
        ...
        `}
      >
        {/* “Nosso Serviço” em azul com borda inferior amarela */}
        ...
        {/* adicionei w-fit mx-auto aqui */}
        <ul className="text-gray-600 leading-relaxed mt-4 space-y-3 w-fit mx-auto md:mx-0">
          <li className="flex items-start gap-3">
            <span className="bg-[#FECB0A] text-black font-bold rounded-full w-6 h-6 flex items-center justify-center text-xs">
              1
            </span>
            <span>
              <strong className="text-[#3970B7]">Professores qualificados</strong>{" "}
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong className="text-[#3970B7]">Flexibilidade de horários</strong>{" "}
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong className="text-[#3970B7]">Seguro e transparente</strong>{" "}
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong className="text-[#3970B7]">Online ou presencial</strong>{" "}
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              <strong className="text-[#3970B7]">Pais satisfeitos</strong>{" "}
              – Alunos evoluindo e notas acima da média.
            </span>
          </li>
        </ul>

        <button className="mt-6 px-4 py-2 bg-[#3970B7] text-white rounded-lg text-base font-semibold hover:bg-blue-600 transition-colors cursor-pointer">
          📅 Agendar Aula →
        </button>
      </div>
