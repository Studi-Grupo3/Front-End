...
=======
        <nav className="h-[10vh] bg-[#3A6FD8] text-white flex items-center">
            <div>
...
const Serviços = () => {
    return (
        <div className="flex flex-col relative">
            ...
            {/* Bloco de imagem */}
            <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 pr-8">
    <img src={imagemDicas} alt="Imagem Dicas" className="w-130 max-w-xl" />
</div>
