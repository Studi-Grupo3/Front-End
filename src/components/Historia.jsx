      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-center items-center md:items-start px-6 md:px-0 text-left">
        <div className="flex flex-col items-center md:items-start space-y-4 max-w-lg text-sm sm:text-base">
          ...
          <p className="text-gray-600 font-[Quicksand] leading-relaxed">
            ...
            individualizado. Identificamos a necessidade de muitos estudantes de
            receberem atenção especial para superar desafios e conquistar seus
            objetivos.
            <br />
            <br />
            Desde o início, nossa missão foi criar um ambiente de aprendizado
            acolhedor e eficaz, onde cada aluno pudesse se desenvolver no seu
