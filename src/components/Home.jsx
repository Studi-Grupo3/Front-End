...
const Home = () => {
    ...
    return (
        <div
            className="w-full bg-[#3970B7] text-white font-quicksand flex flex-col md:flex-row 
            items-center md:items-start relative px-14 sm:px-6 md:px-40 py-12 h-[60vh] 
            md:h-[70vh] overflow-hidden"
        >
            <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left max-w-xl z-10 w-full h-full">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center">
                    <div onClick={handleSaibaMais}>
                        <SaibaMaisButton />
                    </div>

                    <div onClick={handleAgendar}>
                        <AgendarAulaButton />
                    </div>
                </div>
            </div>
