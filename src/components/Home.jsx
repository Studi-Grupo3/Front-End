...
const Home = () => {
    return (
        <div id="home" className="w-full bg-[#FF2345] text-white font-quicksand flex flex-col md:flex-row items-center md:items-start relative px-14 sm:px-6 md:px-40 py-12 h-[60vh] md:h-[70vh] overflow-hidden">
